...
var arr = [
	...
	{ type: 'text', text: '虽然有时候小蚕蚕凶起来我不想理小蚕蚕，但是如果我不理小蚕蚕，小蚕蚕肯定会更伤心更生气更凶的。小蚕蚕特别害怕我不喜欢她，总觉得我对小蚕蚕的爱变少了……所以生气的时候也不能不理小蚕蚕，小蚕蚕不听也要让小蚕蚕听。我要更爱小蚕蚕。' },
	{ type: 'br' },
	{ type: 'text', text: '小蚕蚕说很遗憾没有早点遇到我，我也觉得我们没有早点遇到浪费了好多时间，要是能早点遇到小蚕蚕肯定会和小蚕蚕一起变的更好，好在我们还有好多时间可以在一起磨合，我们会越来越合适。' },
	{ type: 'br' },
	{ type: 'text', text: '每个人都会一直在改变，我和蚕蚕也是的。不要害怕改变，不要害怕和计划不一样的东西。如果什么事情都是一成不变的那世界就会好没意思。' },
	{ type: 'text', text: '我和小蚕蚕互相想着对方，见到了相见的人，从脸红心跳到安心平静，从争吵到，我们还有很长的路要走。我们要一起走一辈子。' },
	{ type: 'br' },
	{ type: 'text', text: '能认识小蚕蚕是一种很特别的体验，能和小蚕蚕结婚是上辈子拯救了世界。' }
]
